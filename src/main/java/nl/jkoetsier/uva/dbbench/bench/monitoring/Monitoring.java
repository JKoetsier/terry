...
import nl.jkoetsier.uva.dbbench.bench.monitoring.stats.CpuStats;
import nl.jkoetsier.uva.dbbench.bench.monitoring.stats.CpuStats.CpuStatsBuilder;
import nl.jkoetsier.uva.dbbench.bench.monitoring.stats.DiskStats;
import nl.jkoetsier.uva.dbbench.bench.monitoring.stats.DiskStats.DiskStatsBuilder;
import nl.jkoetsier.uva.dbbench.bench.monitoring.stats.MemoryStats;
import nl.jkoetsier.uva.dbbench.bench.monitoring.stats.MemoryStats.MemoryStatsBuilder;
...
//    printCpu(hal.getProcessor());
    ...
    //getProcessInfo(os, hal.getMemory(), "docker");
...
//    System.out.println(
//        "Context Switches/Interrupts: " + processor.getContextSwitches() + " / " + processor
//            .getInterrupts());
//
...
//    System.out.println("CPU load averages:" + (loadAverage[0] < 0 ? " N/A"
...
//          FormatUtil.formatBytes(p.getResidentSetSize()), p.getName());
//
//      System.out.format("Read: %d, Written: %d%n", p.getBytesRead(), p.getBytesWritten());
//    }
//
...
//      sb.append(String
//          .format("%n %s @ %.1f%%", pSource.getName(), pSource.getRemainingCapacity() * 100d));
//    }
...
//      System.out.format("   MTU: %s, Speed: %s %n", net.getMTU(),
