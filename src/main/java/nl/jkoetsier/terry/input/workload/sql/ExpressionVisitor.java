...
import nl.jkoetsier.terry.intrep.workload.expression.operator.OperatorFactory;
...
public class ExpressionVisitor extends ExpressionVisitorAdapter {
  ...
  public void visit(NullValue value) {
    expression = new nl.jkoetsier.terry.intrep.workload.expression.NullValue();
  }
  ...
  public void visit(InExpression expr) {
    nl.jkoetsier.terry.intrep.workload.expression.InExpression inExpression
        = new nl.jkoetsier.terry.intrep.workload.expression.InExpression();
  ...
  public void visit(LikeExpression expr) {
    ...
    expression = new nl.jkoetsier.terry.intrep.workload.expression.LikeExpression(
        leftExpr,
        rightExpr,
        expr.isNot()
    );
  ...
  public void visit(ExistsExpression expr) {
    ...
    expression = new nl.jkoetsier.terry.intrep.workload.expression.ExistsExpression(
  ...
  public void visit(ExtractExpression expr) {
    ...
    expression = new nl.jkoetsier.terry.intrep.workload.expression.ExtractExpression(
        expr.getName(),
        fromExpr
    );
  }
  ...
  public void visit(IntervalExpression expr) {
    expression = new nl.jkoetsier.terry.intrep.workload.expression.IntervalExpression(
  ...
  public void visit(ExpressionList expressionList) {
    ...
    expression = new nl.jkoetsier.terry.intrep.workload.expression.ExpressionList(
        expressions);
  }
  ...
  public void visit(Function function) {
    ...
    FunctionExpr functionExpr = new FunctionExpr(function.getName(),
        new nl.jkoetsier.terry.intrep.workload.expression.ExpressionList(expressions));
