package nl.jkoetsier.terry.bench.statistics;
...
import nl.jkoetsier.terry.intrep.workload.meta.TableCounts;
...
public class StatisticsVisitor extends WorkloadVisitor {
  ...
  public StatisticsVisitor(Schema schema) {
    this.schema = schema;
  ...
  public void visit(InputRelation inputRelation) {
    if (inputRelation.getTable() == null) {
      inputRelation.setTable(schema.getTable(inputRelation.getTableName()));
    }
