...
import static nl.jkoetsier.terry.util.Assertions.assertIdentifierEquals;
...
public class SqlSchemaReaderTest {
  ...
  public void testNullNotNull() {
    ...
    Assert.assertEquals(false, table.getColumn("A").isAllowedEmpty());
    Assert.assertEquals(true, table.getColumn("B").isAllowedEmpty());
    Assert.assertEquals(true, table.getColumn("C").isAllowedEmpty());
    Assert.assertEquals(false, table.getColumn("D").isAllowedEmpty());
  }
